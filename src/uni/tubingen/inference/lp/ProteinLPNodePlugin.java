 ...
 * @author enrique
 */
public class ProteinLPNodePlugin extends Plugin {
    // The shared instance.
    private static ProteinLPNodePlugin plugin;

    /**
     * The constructor.
     */
    public ProteinLPNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ProteinLPNodePlugin getDefault() {
        return plugin;
    }
